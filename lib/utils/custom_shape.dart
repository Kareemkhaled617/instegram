...
class RPSCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint4Fill.color = const Color(0xffF44D71).withOpacity(1.0);
    canvas.drawCircle(Offset(size.width*0.5000010,size.height*0.3311414),size.width*0.1578127,paint4Fill);
